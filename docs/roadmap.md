...
└── roadmap/
    ...
    ├── phase-14-5-pipeline-hardening.md        # 4 review-deferred items closed (one shipped in v0.8.0), publish pending; Task 5 (S3776) still open
